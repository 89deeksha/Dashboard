  ...
  return (
    <div className="container">
      <div className="col-md-12 d-flex justify-content-between">
        {/* <button type="button" className="btn btn-primary rounded-pill" id="btn">
          Chat history
        </button> */}
        {/* <GoArrowUpRight /> */}
      </div>
        ...
        <div className="col-md-4 ">
          ...
          <div className="col-md-12 ">
            <div className="col-md-12 border rounded-3  d-flex gap-3 m-1">
              <img className="img rounded-circle" src={img1} />
            ...
            <div className="col-md-12 border rounded-3  d-flex gap-3 m-1">
              <img className="img rounded-circle" src={img2} />
              <div className="text d-flex col-md-9 justify-content-between">
                <div>
            ...
            <div className="col-md-12 border rounded-3  d-flex gap-3 m-1">
              <img className="img rounded-circle" src={img3} />
              <div className="text d-flex col-md-9 justify-content-between">
                <div>
            ...
            <div className="col-md-12 border rounded-3  d-flex gap-3 m-1">
              <img className="img rounded-circle" src={img4} />
              <div className="text d-flex col-md-9 justify-content-between">
                <div>
